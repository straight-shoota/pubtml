...
var _ = self.Prism = {
	...
	highlightAll: function(async, callback) {
		var elements = $('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code');

		elements.each(function(){
			_.highlightElement(this, async === true, callback);
		})
	},
	...
	highlightElement: function(element, async, callback) {
		...
		$(element).parent('pre').addClass('language-' + language)

		/*if (/pre/i.test(parent.nodeName)) {
			parent.className = parent.className.replace(lang, '').replace(/\s+/g, ' ') + ' language-' + language;
		}*/

		var code = $(element).text().replace(/^\s+|\s+$/g, '');
